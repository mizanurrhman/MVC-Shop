...
namespace mvc_shop.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel() {
            ...
            products.Insert(new Product() { Id = "2", Price = 12.00m });
        ...
        public void CanCheckOutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "mvcshop@gmail.com", ZipCode="53000" });

            IPrincipal FakeUser =new  GenericPrincipal(new GenericIdentity("mvcshop@gmail.com", "Forms"),null);
